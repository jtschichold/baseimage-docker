...
apt-get remove -y gdebi-core autoconf automake autopoint autotools-dev binutils bsdmainutils \
	...
	libgcc-5-dev libgdbm3 libgomp1 libgpm2 libisl15 libitm1 liblsan0 libmpc3 \
	libmpfr4 libmpx0 libpcre3-dev libperl5.22 \
	...
	linux-libc-dev m4 make man-db patch perl perl-modules-5.22 pkg-config \
